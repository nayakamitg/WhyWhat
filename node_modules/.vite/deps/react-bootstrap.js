...
var DropdownButton = React36.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime36.jsxs)(Dropdown_default, {
  ref,
  ...props,
  children: [(0, import_jsx_runtime35.jsx)(DropdownToggle_default, {
    id,
    href,
    size: size2,
    variant,
    ...
    children: title
  }), (0, import_jsx_runtime35.jsx)(DropdownMenu_default, {
    role: menuRole,
...
var FormCheck = React45.forwardRef(({
  ...
  const innerFormContext = (0, import_react16.useMemo)(() => ({
...
function useNavItem({
  ...
  const parentOnSelect = (0, import_react23.useContext)(SelectableContext_default);
  const navContext = (0, import_react23.useContext)(NavContext_default);
  const tabContext = (0, import_react23.useContext)(TabContext_default);
  let isActive = active;
  const props = {
    role
  };
...
function useCallbackRef2() {
  return (0, import_react25.useState)(null);
}
...
var Modal = React68.forwardRef(({
  ...
  const renderBackdrop = (0, import_react26.useCallback)((backdropProps) => (0, import_jsx_runtime69.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React75.forwardRef(({
  onHide,
  ...props
}, ref) => {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime90.jsxs)(import_jsx_runtime89.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react36.cloneElement)(children, triggerProps), (0, import_jsx_runtime88.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
